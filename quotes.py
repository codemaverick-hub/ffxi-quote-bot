...
# ─────────────────────────────────────────────
#  Source Tag Helpers
#  G() = confirmed in-game dialogue
#  F() = fan-written in character
#  M() = community / meme content
# ─────────────────────────────────────────────
...
def G(speaker: str, quote: str) -> tuple: return (speaker, quote, GAME)
def F(speaker: str, quote: str) -> tuple: return (speaker, quote, FAN)
def M(speaker: str, quote: str) -> tuple: return (speaker, quote, MEME)
...
NPC_STORY = [
    # ── Confirmed Game Dialogue ─────────────────────────────────────────────
    G("Shantotto", "Pound until you can't pound again."),
    G("Shantotto", "Oh ho ho ho ho ho ho ho ho ho ho ho ho ho ho!"),
    G("Shantotto", "What's that you said? You want to be blasted back to the beginning?"),
    G("Shantotto", "You should know that I, the great Shantotto, have no equal!"),
    G("Shantotto", "You dare to face the great Shantotto? Oh ho ho! How delightfully foolish!"),
    G("Prishe", "If you guys don't get your act together, I am gonna kick you into next Watersday!"),
    G("Prishe", "I'm gonna send you to next Watersday!"),
    G("Ajido-Marujido", "You should be thankful. I'll give you a shortaru trip back to the hell you came from!"),
    G("Yoran-Oran", "You'll not surprise me again..."),
    G("Runga-Kopunga", "Oh, baby-baby! We've gotta go for it! Don't keep me hangin' on the line of a yo-yo. You've got to take action on my reaction!"),
    G("CoP Tarutaru Father", "My wife blasted me with meteor so many times I don't even feel it anymore!! Bring it on!"),
    G("Shirakee Y", "Just for you, sweetiepie!"),
    G("Antreneau", "By Altana! Not beans again!"),
    G("Wise Owl", "Grit your teeth and prepare to feel the power of Wise Owl..."),
    # ── Fan Written ─────────────────────────────────────────────────────────
...
MOOGLE_QUIPS = [
    # ── Confirmed Game Dialogue ─────────────────────────────────────────────
    G("Moogle", "Kupo! Kupo kupo!"),
    G("Rent-a-Room Moogle", "Step right this way to entaru your Rent-a-Roomie!"),
    G("Moogle", "Kupo! I am your moogle! Your very own moogle, kupo!"),
    G("Moogle", "Kupopo! This is your Mog House, kupo! I will keep it clean for you, kupo!"),
    # ── Fan Written ─────────────────────────────────────────────────────────
...
CITY_FLAVOR = [
    # ── Confirmed Game Dialogue ─────────────────────────────────────────────
    G("Mhaura NPC Child", "When I grow up I'm going to be a beesmaster!"),
    G("Mhaura NPC Child", "I'm not marrying any beesmaster."),
    G("Windurst Tarutaru", "Howdy-wowdy!"),
    G("Windurst Tarutaru", "Damnitaru!"),
    G("Lower Jeuno NPC", "Fatty! Fanny! Flush!"),
    G("Star Onion Brigade Tarutaru", "S.O.B.!"),
    # ── Fan Written ─────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────
#  Community Meme Quotes
# ─────────────────────────────────────────────

COMMUNITY_QUOTES = [
    M("FFXI Player", "LFP — any job, any level, please, I've been at this camp for four hours"),
    M("FFXI Player", "The RNG is not broken. It simply does not love you. There is a difference."),
    M("FFXI Player", "Claim lost. Alliance disbanded. Linkshell drama incoming. Classic Tuesday."),
    M("FFXI Player", "My character has been standing in Jeuno for 45 minutes. This IS the content."),
    M("FFXI Player", "Someone in my party just used Mijin Gakure. We lost a ninja and won nothing."),
    M("FFXI Player", "The Haubergeon dropped. I was AFK. I will never know peace again."),
    M("FFXI Player", "Server: Asura. Population: Yes."),
    M("FFXI Player", "I set my alarm for the NM window. I slept through it. This is my story."),
    M("FFXI Player", "Spent three hours in Dynamis. Got a Dynamis currency. It was not the one I needed."),
    M("FFXI Player", "My linkshell is currently debating whether Absolute Virtue is beatable. We have been debating for six years."),
    M("FFXI Player", "Returning player. Just needs to re-learn 15 jobs, 23 years of patches, and where Adoulin is. Easy."),
    M("FFXI Player", "Nobody warned me Chains of Promathia would make me feel things. I was not warned."),
    M("FFXI Player", "BRD needed. Must have Minuet V, Ballad II, Elegy, Lullaby. Also: Refresh.  Also: please hurry it's been 2 hours."),
    M("FFXI Player", "My Wyvern died. I am fine. Everything is fine."),
    M("FFXI Player", "Some people unsubscribed from FFXI. Some of us came back. The difference is discipline. We lack it."),
]
...
_COP_SPEAKERS  = {"Prishe", "Selh'teus", "Nag'molada", "Ulmia", "Tenzen", "Ajido-Marujido", "Yoran-Oran", "CoP Tarutaru Father"}
_TOAU_SPEAKERS = {"Aphmau", "Luzaf", "Shantotto", "Lehko Habhoka", "Runga-Kopunga"}
...
ALL_QUOTES = (
    ...
    PLAYER_SAY + ABYSSEA_QUOTES + COMMUNITY_QUOTES
)
